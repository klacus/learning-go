...
// simple function, no error checking
...
func getBalanceFromFile() (float64, error) {
	...
	if err != nil {
		...
		return 1000.00, errors.New("error reading balance file") // default balance
	}
	...
	if err != nil {
		...
		return 1000.00, errors.New("error parsing balance") // default balance
	}
...
func main() {
	...
	for {
		...
		case 2:
			...
			writeBalanceToFile(accountBalance) // Write the updated balance to the file
