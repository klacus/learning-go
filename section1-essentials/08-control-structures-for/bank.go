...
func main() {
	...
	for {
		...
		if choice == 1 {
			...
			fmt.Println("Goodbye!")
			// return // not returning here as we want a message after the infinite loop which would be unreachable
			break // exit the infinite loop
		}
	}

	fmt.Println("Thank you for using the bank. Goodbye!") // this message will be printed after exiting the loop
}
